 ...
 */
class Version20180313200619 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE rota_slot_staff (id INT AUTO_INCREMENT NOT NULL, rotaid INT NOT NULL, daynumber INT NOT NULL, staffid INT DEFAULT NULL, slottype VARCHAR(20) NOT NULL, starttime TIME DEFAULT NULL, endtime TIME DEFAULT NULL, workhours NUMERIC(10, 2) DEFAULT NULL, premiumminutes INT DEFAULT NULL, roletypeid INT DEFAULT NULL, freeminutes INT DEFAULT NULL, seniorcashierminutes INT DEFAULT NULL, splitshifttimes VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE rota_slot_staff');
    }
}
